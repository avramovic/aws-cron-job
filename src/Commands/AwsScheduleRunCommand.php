...
class AwsScheduleRunCommand extends ScheduleRunCommand
{
    ...
    public function handle(Schedule $schedule, Dispatcher $dispatcher, ExceptionHandler $handler)
    {
        if ($this->shouldRunEnvironment()) {
            ...
            $this->runSchedules($schedule, $dispatcher, $handler);
            exit(0);
        }
        ...
        if (empty($activeInstances)) {
            ...
            $this->runIfEnabled($schedule, $dispatcher, $handler);
        }
    ...
    protected function runIfEnabled(Schedule $schedule, Dispatcher $dispatcher, ExceptionHandler $handler, $thenStop = true)
    {
    ...
    protected function runSchedules(Schedule $schedule, Dispatcher $dispatcher, ExceptionHandler $handler)
    {
